...
<div class="main-content">
    ...
    <div class="add-button">
        <a href="{{ route('admin.block.module.create') }}">Add Block</a>
    </div>
    <div class="row">
...
<script>
    ...
    $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.block.data.index') }}",
        columns: [
            {data: 'block_name', name: 'block_name', orderable:true, searchable:true, className: 'text-center'},
            {data: 'block_order', name: 'block_order', orderable:true, searchable:true, className: 'text-center'},
